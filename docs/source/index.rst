...
Далі розглянемо як основні проблеми яких можно уникати та основні способи та підходи як можна робити імена та назви краще.
...
Використовуйте контрольовані словники та каталоги
**********
...
Використовуйте каталоги
**********

| Гарною ілюстрацією використання каталогів можуть бути каталоги творів класичної музики, назви яких доволі спеціфічні та буває складно відшукати потрібний твор.

.. note::
   Так, для ідентифікації творів Моцарта прийнято використовувати каталог Кехеля який у 1862 році склав у хронологічному порядку всі відомі твори.
   ``W.A. Mozart - Symphony No. 40 in G minor, K. 550``
   Або для ідентифікації творів Баха використовуєтся каталог Bach-Werke-Verzeichnis (BWV), складений Вольфгангом Шмидером.
...
Зробіть назви унікальними або визначенними
**********
